...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Khu vực</h3>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            <div style="display: flex"><h4><i class="fa fa-angle-right"></i> Tất cả khu vực </h4>
                                <a style="margin-left: 50px;" href="add_khuvuc.php">
                            ...
                            <tbody>
                            <?php $ret = mysqli_query($con, "select * from khuvuc");
                            $cnt = 1;
                            while ($row = mysqli_fetch_array($ret)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="update_khuvuc.php?uid=<?php echo $row['id']; ?>">
                                            <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                        </a>
                                        <a href="khuvuc.php?id=<?php echo $row['id']; ?>">
