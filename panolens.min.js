(function (h, e) {
    ...
    function z(a, b, c) {
        ...
        c = function (d) {
            if (this.material) {
                var b = d.image.width / d.image.height, c = new e.Vector3;
    ...
    function W() {
        var a = new e.BufferGeometry, b = new e.MeshBasicMaterial({color: 0, opacity: 0, transparent: !0});
    ...
    function B(a, b) {
        b = void 0 === b ? {} : b;
        var c = new e.SphereBufferGeometry(5E3, 60, 40), d = new e.MeshBasicMaterial({opacity: 0, transparent: !0});
        n.call(this, c, d);
        this.src = a;
        this.options = {
    ...
    function J(a) {
        var b = new e.SphereBufferGeometry(5E3, 60, 40), c = new e.MeshBasicMaterial({visible: !1});
        n.call(this, b, c);
        this.media = new S(a);
        this.radius = 5E3;
    ...
    function ba(a, b) {
        ...
        var f = this, D = new e.Vector2, h = new e.Vector2, r = new e.Vector2, n = new e.Vector2, U = new e.Vector2,
            t = new e.Vector2, u = new e.Vector3, A = new e.Vector3, y = new e.Vector2, z = new e.Vector2,
            T = new e.Vector2, R = 0, H = 0, B = 0, C = 0, E = 1,
            F = new e.Vector3, M = new e.Vector3, N = new e.Quaternion, K = 0, L = 0, G, Q = !1, I, J, X, Y,
            w = {NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_DOLLY: 4, TOUCH_PAN: 5}, x = w.NONE;
        this.target0 = this.target.clone();
        this.position0 = this.object.position.clone();
        this.zoom0 = this.object.zoom;
        var S = (new e.Quaternion).setFromUnitVectors(a.up, new e.Vector3(0, 1, 0)), W = S.clone().inverse(),
            V = {type: "change"}, O = {type: "start"}, P = {type: "end"};
            ...
            if (!1 !== c.enabled) {
                var b = c.deviceOrientation.alpha ? e.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle : 0,
                    ...
                    f = c.deviceOrientation.gamma ? e.Math.degToRad(c.deviceOrientation.gamma) :
                        0, p = c.screenOrientation ? e.Math.degToRad(c.screenOrientation) : 0, m = c.camera.quaternion,
                    l = new e.Vector3(0, 0, 1), D = new e.Euler, q = new e.Quaternion,
                    v = new e.Quaternion(-Math.sqrt(.5), 0, 0, Math.sqrt(.5)), h = new e.Quaternion,
                    r = new e.Quaternion;
    ...
    function ha(a) {
        ...
        var k = new e.Vector2(.441, .156),
            ...
            m = p.attributes.position.array, l = p.attributes.uv.array;
    ...
    var ja = "^0.105.2".replace(/[^0-9.]/g, ""), E = {ORBIT: 0, DEVICEORIENTATION: 1},
        t = {UNKNOWN: 0, NORMAL: 1, CARDBOARD: 2, STEREO: 3}, u = {
    ...
    S.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        setContainer: function (a) {
            ...
            var a = this.stop.bind(this), b = this.start.bind(this),
                c = this.setVideDeviceIndex.bind(this), d = this.videoDeviceIndex;
            ...
            var a =
                this.element, b = new e.VideoTexture(a);
            b.generateMipmaps = !1;
    ...
    M.prototype =
        Object.assign(Object.create(e.Sprite.prototype), {
            constructor: M, setColor: function (a) {
            ...
            updateCanvasArcByProgress: function (a) {
                var b = this.context, c = this.canvasWidth, d = this.canvasHeight, g = this.material, k = this.dpr,
                    e = a * Math.PI * 2, m = this.color.getStyle(), l = .5 * c / k;
                k = .5 * d / k;
                b.clearRect(0, 0, c, d);
                b.beginPath();
                ...
                var a = this, b = this.context, c = this.canvasWidth, d = this.canvasHeight, g = this.material,
                    k = this.rippleDuration,
                    e = performance.now(), m = this.color, l = this.dpr, h = .5 * c / l, q = .5 * d / l,
                    f = function () {
                        var p = window.requestAnimationFrame(f), v = (performance.now() - e) / k,
                            n = 0 < 1 - v ? 1 - v : 0, r = v * c * .5 / l;
                        b.clearRect(0, 0, c, d);
                        b.beginPath();
    ...
    var r = function (a, b) {
        ...
        c.Tween.prototype = {
            ...
            stopChainedTweens: function () {
                ...
                for (b in this._valuesEnd) if (void 0 !== this._valuesStart[b]) {
                    var e = this._valuesStart[b] || 0, l = this._valuesEnd[b];
        ...
        c.Interpolation = {
            Linear: function (a, b) {
                var d = a.length - 1, g = d * b, e = Math.floor(g), l = c.Interpolation.Utils.Linear;
                ...
                var d = a.length - 1, g = d * b, e = Math.floor(g), l = c.Interpolation.Utils.CatmullRom;
    ...
    z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
        constructor: z, setContainer: function (a) {
        ...
        onClick: function (a) {
            ...
            if (this.getContainer()) {
                var b = this.cursorStyle || (this.mode === t.NORMAL ? "pointer" : "default"),
                    c = this.scaleDownAnimation, d = this.scaleUpAnimation, g = this.element;
                this.isHovering = !0;
    ...
    I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        constructor: I, addControlBar: function () {
            ...
            return [{
                title: "Điều khiển",
                subMenu: [{
                    title: this.TOUCH_ENABLED ? "Touch" : "Chuột",
                    handler: b("enableControl", E.ORBIT)
                }, {title: "Cảm biến", handler: b("enableControl", E.DEVICEORIENTATION)}]
            }, {
                title: "Cách thức",
                subMenu: [{title: "Bình thường", handler: b("disableEffect")}, {
                    title: "Các tông",
            ...
            var b = this, c = !1, d = !0, g = this.container;
        ...
        createVideoControlSeekbar: function () {
            ...
            var d = this, e, k = this.createMenu();
            k.items = b;
            k.activeItem = null;
        ...
        add: function (a) {
            ...
            if (a instanceof z) {
                if (b = a, a.dispatchEvent) {
                    ...
                    a.dispatchEvent({
                        type: "panolens-infospot-focus", method: function (a, b, c) {
                            this.dispatchEvent({
                                type: "panolens-viewer-handler",
    ...
    y.prototype = Object.assign(Object.create(n.prototype), {
        constructor: y, load: function (a) {
            a = a || this.src;
            if (!a) console.warn("Image source undefined"); else if ("string" === typeof a) N.load(a, this.onLoad.bind(this), this.onProgress.bind(this), this.onError.bind(this)); else if (a instanceof HTMLImageElement) this.onLoad(new e.Texture(a))
        },
        onLoad: function (a) {
    ...
    B.prototype = Object.assign(Object.create(n.prototype), {
        constructor: B, isMobile: function () {
            ...
            var a = this.options, b = a.muted, c = a.loop, d = a.autoplay, e = a.playsinline;
            a = a.crossOrigin;
            var k = this.videoElement, h = this.material, m = this.onProgress.bind(this), l = this.onLoad.bind(this);
            k.loop = c;
            k.autoplay = d;
            k.playsinline = e;
            k.crossOrigin = a;
    ...
    Object.assign(P.prototype, {
        constructor: P, setProgress: function (a, b) {
            ...
            for (var e = 0; e < this._hc; e++) for (var k = 0; k < this._wc; k++) {
            ...
            var d = this.maxW, e = this.maxH;
            a *= 512;
            b *= 512;
            var k = Math.floor(a / d), h = Math.floor(b / e);
            this._ctx[h *
    ...
    C.prototype = Object.assign(Object.create(y.prototype), {
        constructor: C, add: function (a) {
            ...
            switch (a.touches && a.touches.length || 1) {
                case 1:
                    var b = 0 <= a.clientX ? a.clientX :
                        a.touches[0].clientX;
                    a = 0 <= a.clientY ? a.clientY : a.touches[0].clientY;
                    var c = .4 * e.Math.degToRad(b - this.userMouse.x), d = .4 * e.Math.degToRad(a - this.userMouse.y);
            ...
            var b = this.material.uniforms, c = .1 * this.size, d = 10 * this.size;
            b.zoom.value += a;
    ...
    aa.prototype = Object.assign(Object.create(C.prototype), {
        constructor: aa, onLoad: function (a) {
            this.updateTexture(a);
    ...
    J.prototype = Object.assign(Object.create(n.prototype), {
        constructor: J, onPanolensContainer: function (a) {
    ...
    da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        onWindowResize: function (a, b) {
            ...
            if (!a || !a.target || a.target.classList.contains("panolens-canvas")) if (a.preventDefault(),
            ...
            var c = this.container.getBoundingClientRect(), d = c.top, e = this.container, h = e.clientHeight;
            ...
            if (this.panorama) {
                ...
                if ("click" === b) this.panorama.dispatchEvent({
                    ...
                    type: "click-entity",
                    mouseEvent: a
                }), e && e.dispatchEvent && e.dispatchEvent({type: "click", mouseEvent: a}); else {
            ...
            this.control.update();
            this.scene.traverse(function (a) {
                if (a instanceof z && a.element && (this.hoverObject === a || "none" !== a.element.style.display || a.element.left && "none" !== a.element.left.style.display || a.element.right && "none" !== a.element.right.style.display)) if (this.checkSpriteInViewport(a)) {
